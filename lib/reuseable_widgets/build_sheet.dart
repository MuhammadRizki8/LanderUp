...
import 'package:lender_up/reuseable_widgets/build_sheet_mendanai.dart';
              ...
              children: [
                Column(
                  children: [
                    ...
                    Container(
                      child: Text("Rp.${data['nominal_pinjaman'].toString()}",
                          style: GoogleFonts.poppins(
                              textStyle: TextStyle(
                            color: Colors.black,
                            fontSize: 10,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                    Text("Rp.${data['penghasilan_per_bulan'].toString()}",
                        style: GoogleFonts.poppins(
                            textStyle: TextStyle(
                          color: Color(0xff000000),
                          fontSize: 10,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                    ...
                    Text("Rp.${data['bagi_hasil_jmlh'].toString()}",
                        style: GoogleFonts.poppins(
                            textStyle: TextStyle(
                          color: Color(0xff000000),
                          fontSize: 10,
                    ...
                    Text("Rp.${data['jumlah_angsuran'].toString()}",
                        style: GoogleFonts.poppins(
                            textStyle: TextStyle(
                          color: Color(0xff000000),
                          fontSize: 10,
