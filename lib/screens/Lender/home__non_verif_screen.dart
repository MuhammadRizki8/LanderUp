...
import 'package:lender_up/reuseable_widgets/card_dompet.dart';
import 'package:lender_up/reuseable_widgets/card_porto_simple.dart';
import 'package:lender_up/reuseable_widgets/card_telusuri.dart';
import 'package:lender_up/reuseable_widgets/card_verifikasi.dart';
import 'package:lender_up/reuseable_widgets/total_aset.dart';
import 'package:lender_up/screens/Lender/porto_screen.dart';
import 'package:lender_up/screens/dompet_screen.dart';
import 'package:lender_up/screens/Lender/telusuri_screen.dart';
...
class _HomeNonVerifScreenState extends State<HomeNonVerifScreen> {
  ...
  Widget getBodyWidget() {
    switch (idx) {
      ...
      case 3:
        return DompetScreen(accessToken: widget.accessToken);
      case 4:
